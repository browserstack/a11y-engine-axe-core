...
function linkInTextBlockUpdatedEvaluate(node, options) {
  ...
  if (evaluateOptions.a11yRule) {
    ...
    return a11yEngine.commons.distinguishableLinkUpdatedEvaluate(
      node,
      parentBlock
    );
  }
...
export default linkInTextBlockUpdatedEvaluate;
