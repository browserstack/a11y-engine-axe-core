...
// a11y-rule-label-content-name-mismatch : changes for False Positive reduction
...
/**
 * a11y-rule-label-content-name-mismatch (TBD) : function to check if a given text exists in another or not
 *
