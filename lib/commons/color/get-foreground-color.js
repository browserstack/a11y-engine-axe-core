...
export default function getForegroundColor(node, _, bgColor, options = {}) {
  ...
  // colorParse (upstream 4.12.1): a parse throw with colorParse set -> Can't Tell
  try {
  ...
  // colorParse (upstream 4.12.1): a parse failure -> Can't Tell, before the fork's
  // degraded-mode fgColor return
