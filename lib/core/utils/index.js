...
export { default as dqSelectorsFromNodes } from './dq-selectors-from-nodes'; // a11y-critical: shared bulk-review selector helper
...
export { default as getElementInternals } from './get-element-internals';
...
export { default as isValidCustomElementName } from './is-valid-custom-element-name';
