...
function generateSelector(elm, options, doc) {
  ...
  do {
    ...
    // a11y-critical : If there are too many similar element running QSA again is faster
...
// a11y-critical : Axe can call getSelector more than once for the same element because
// the same element can end up on multiple DqElements.
export default memoize(getSelector);

// a11y-critical : Similar elements create similar selectors. If there are lots of similar elements on the page,
